...
top_model_weights_path = 'bottleneck_fc_model.h5' 	##name for the weight file to save 
train_data_dir = 'data/train'    					#path to training images 
validation_data_dir = 'data/validation'				#path to testing images 

epochs =25										# number of epochs to train top model
batch_size=16									# batch size used by flow_from_directory and predict_generator
